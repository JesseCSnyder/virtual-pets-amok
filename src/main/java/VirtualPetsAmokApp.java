...
public class VirtualPetsAmokApp {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("Enter [9] to leave the store");
			...
			if (optionSelect.equals("1")) {
				...
				System.out.println(litterBox.getFillLevel());
			} else if (optionSelect.equals("8")) {
				myVirtualPetShelter.oilPets();
			}
			
			else {
				if (!optionSelect.equals("9"))
					System.out.println("Please try again.");
			}

		} while ((!optionSelect.equals("9")) && (!myVirtualPetShelter.petValues().isEmpty()));
